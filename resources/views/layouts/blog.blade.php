        ...
        <div class="row">
            <div class="col-lg-6 offset-lg-3">
                <div class="main-title text-center">
                    <h3 class="mt0">Últimas noticias y eventos</h3>
                </div>
            </div>
        </div>
        <div class="row">
                    ...
                    <div class="item">
                        <div class="blog_post one">
                            <div class="thumb">
                                ...
                                <img class="img-fluid w100" src="img/blog/1.jpg" alt="1.jpg">
            ...
            <div class="col-md-6 col-lg-3 col-xl-3">
                <div class="blog_post">
                    <div class="thumb">
                        <img class="img-fluid w100" src="img/blog/2.jpg" alt="2.jpg">
        ...
        <div class="row mt50">
            <div class="col-lg-12">
                <div class="read_more_home text-center">
                    <h4>Quieres ver más información? <a href="#">Click Aqui<span class="flaticon-right-arrow pl10"></span></a></h4>
                </div>
            </div>
        </div>
    </div>
