        ...
        <nav>
            ...
            <ul class="header_user_notif pull-right dn-smd">
                ...
                <li class="user_setting">
                    <div class="dropdown">
                        <a class="btn dropdown-toggle" href="#" data-toggle="dropdown"><img class="rounded-circle" src="{{asset(Auth::user()->avatar)}}" style="height: 50px; width:50px; object-fit: cover; object-position: center center;" alt="avatar"></a>
                        <div class="dropdown-menu">
                            <div class="user_set_header">
                                <img class="float-left" src="{{asset(Auth::user()->avatar)}}" style="height:50px; width:50px; object-fit: cover; object-position: center center;" alt="avatar">
