                ...
                <div class="row my_setting_content_details">
                    <div class="col-xl-12">
                        ...
                        <div class="my_profile_setting_input form-group">
                            <!-- <label for="title_leccion">Curso</label> -->
                            <!-- <input type="text" class="form-control" value="{{$curso->title}}" disabled> -->
                        </div>
                        <div class="my_profile_setting_input form-group">
                            <label for="title_leccion">Nombre Leccion</label>
                            <input type="text" class="form-control" id="title_leccion" name="title_leccion" placeholder="preparación y utensilios" value="{{old('title_leccion')}}" maxlength="50" onkeypress="return soloLetras(event)">
                        </div>
                    </div>
                    <div class="col-xl-12">
                        <div class="my_profile_setting_input form-group">
